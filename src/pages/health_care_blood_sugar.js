export default function HealthCareBloodSugar() {
  return (
    <>
      ...
      <div className="padding_8_16">
        <div className="display_flex_row space_between align_items_center blood_sugar_list_box">
          <div className="display_flex_row gap_12 align_items_center ">
            <img src="/img/home_record_off_4.svg" width="40" height="40"></img>
              ...
              <div className="display_flex_row align_items_center gap_8">
                <div className="display_flex_row align_items_center gap_8">
                  ...
                  <div className="font_17 weight_semi_bold colo_gray_80">
                    92
                    <span className="font_14 weight_medium colo_gray_70">
                      mg/dL
                    </span>
                  </div>
                </div>
                ...
                <div className="display_flex_row align_items_center gap_2">
                  <img src="/img/insulin.svg" width="16" height="16"></img>
      ...
      <div className="padding_8_16">
        <div className="display_flex_row space_between align_items_center blood_sugar_list_box">
          <div className="display_flex_row gap_12 align_items_center ">
            <img src="/img/home_record_off_3.svg" width="40" height="40"></img>
            <div className="display_flex_column gap_4">
              <div className="display_flex_row align_items_center gap_8">
                <div className="display_flex_row align_items_center gap_8">
                  <div className="health_care_button_common health_care_button_off_2 background_gray_10 font_12 text_align_center weight_regular color_gray_80 border_gray_20">
                    식후
                  </div>
                  <div className="font_17 weight_semi_bold colo_gray_80">
                    160
      ...
      <div className="padding_8_16">
        <div className="display_flex_row space_between align_items_center blood_sugar_list_box">
          <div className="display_flex_row gap_12 align_items_center ">
            <img src="/img/home_record_off_2.svg" width="40" height="40"></img>
            <div className="display_flex_column gap_4">
              <div className="display_flex_row align_items_center gap_8">
                <div className="display_flex_row align_items_center gap_8">
                  <div className="health_care_button_common health_care_button_off_2 background_gray_10 font_12 text_align_center weight_regular color_gray_80 border_gray_20">
      ...
      <div className="padding_8_16">
        <div className="display_flex_row space_between align_items_center blood_sugar_list_box">
          <div className="display_flex_row gap_12 align_items_center ">
            <img src="/img/home_record_off_1.svg" width="40" height="40"></img>
            <div className="display_flex_column gap_4">
              <div className="display_flex_row align_items_center gap_8">
                <div className="display_flex_row align_items_center gap_8">
                  <div className="health_care_button_common health_care_button_off_2 background_gray_10 font_12 text_align_center weight_regular color_gray_80 border_gray_20">
