export default function FamilyManagement3() {
  return (
    <>
      ...
      <ul className="background_gray_5 padding_0_20 display_flex_column gap_12">
        ...
        <li className="position_relative display_flex_column gap_24_ border_gray_20 radius_8 background_gray_0 padding_16">
          <div className="display_flex_row space_between">
            <div className="display_flex_row gap_8 align_items_center">
              <img
                src="/img/profile.png"
            ...
            <div>
              <img src="/img/more_gray.svg"></img>
              <div className="more_popup_common2 background_gray_0 shadow_normal display_flex_column radius_4 justify_content_center">
                <div className="display_flex_row padding_8_12 gap_8">
                  <img
                    ...
                    alt="delete"
                  ></img>
                  <div className="font_15 weight_regular color_C0392B">
                    가족 연결 취소
                  </div>
                </div>
              </div>
