export default function HealthCareHistory3() {
  return (
    <>
      <div className="top_title_wrap display_flex_row ">
        <img
          ...
          alt="arrow left"
        ></img>
        <span className="font_17 weight_semi_bold">체중 관리 이력</span>
      </div>
            ...
            <div className="display_flex_column">
              ...
              <div className="display_flex_row gap_4 align_items_center">
                <div className="display_flex_row align_items_baseline">
                  <div className="font_32 weight_bold colo_gray_90">65.9</div>
